...
class CappCustomButton extends StatelessWidget {
  ...
  const CappCustomButton(
      {Key? key,
        ...
        this.secGradientColor = const Color(0xFF035FAE), this.borderRadius = 8})
      : super(key: key);
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: !isSolidColor ? null : hasBorder
              ? Colors.transparent
              : isActive
              ? color
              : color.withOpacity(.3),
          gradient: !isSolidColor ? LinearGradient(
              colors: [
                hasBorder
                    ? Colors.transparent
                    : isActive
          ...
          borderRadius: BorderRadius.circular(borderRadius),
          border: hasBorder
              ? Border.all(width: borderWidth, color: isActive ? borderColor : borderColor.withOpacity(.4))
              : null,
