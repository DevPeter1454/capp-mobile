...
class ImageWidgetWithShimmerLoader extends StatelessWidget {
  const ImageWidgetWithShimmerLoader({Key? key, required this.image, this.loadingWidget, this.errorWidget,  this.height,  this.width, this.highlightColor, this.baseColor}) : super(key: key);
  final String image;
      ...
      child:
        Image.network(image,
          ...
          loadingBuilder: (BuildContext context, Widget child, ImageChunkEvent? loadingProgress) {
            ...
            return loadingWidget ?? Shimmer.fromColors(
