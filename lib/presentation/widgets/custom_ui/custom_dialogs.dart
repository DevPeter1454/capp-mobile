...
class CustomDialogWidgets {
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Icon(
                                            itemSelected == e.key ? Icons
                                                .check_circle : Icons.circle,
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    color:iconBgColor ?? Colors.red.withOpacity(.1),
                                  ),
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: Row(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Checkbox(value: showOnNextStartup,
                                          onChanged: (val) {
                                            setModalState(() {
                                              showOnNextStartup =
                                              !showOnNextStartup;
                                        ...
                                        Text(
                                          moreText ??'Don’t show this again', style: const TextStyle(
                                          fontWeight: FontWeight.w400,
                                          fontSize: 12,
                                        ),)
                                      ],
  ...
  static copyText(String text, String infoText,) {
