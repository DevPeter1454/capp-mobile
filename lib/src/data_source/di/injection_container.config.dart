...
import 'package:capp/src/data_source/di/module/app_module.dart' as _i19;
...
import 'package:capp/src/data_source/repository/user_repository%20impl.dart'
    as _i12;
import 'package:capp/src/domain/repository/auth_repository.dart' as _i13;
import 'package:capp/src/domain/repository/fgn_support_repository.dart' as _i8;
import 'package:capp/src/domain/repository/user_repository.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i10.SupportSchemeCubit>(
        () => _i10.SupportSchemeCubit(gh<_i8.FgnSupportRepository>()));
    ...
    gh.factory<_i15.LoginCubit>(
        () => _i15.LoginCubit(gh<_i13.AuthRepository>()));
    ...
    gh.factory<_i17.SignUpCubit>(
        () => _i17.SignUpCubit(gh<_i13.AuthRepository>()));
    gh.factory<_i18.UserProfileCubit>(
        () => _i18.UserProfileCubit(gh<_i11.UserRepository>()));
    return this;
  }
}
