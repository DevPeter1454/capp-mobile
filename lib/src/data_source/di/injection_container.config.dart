...
import 'package:capp/src/data_source/di/module/app_module.dart' as _i24;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i20.LoginCubit>(
        () => _i20.LoginCubit(gh<_i18.AuthRepository>()));
    ...
    gh.factory<_i22.SignUpCubit>(
        () => _i22.SignUpCubit(gh<_i18.AuthRepository>()));
    gh.factory<_i23.UserProfileCubit>(
        () => _i23.UserProfileCubit(gh<_i16.UserRepository>()));
    return this;
  }
}
