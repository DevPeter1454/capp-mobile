...
/// @nodoc
abstract class _$$RetrievedImplCopyWith<$Res> {
  factory _$$RetrievedImplCopyWith(
          _$RetrievedImpl value, $Res Function(_$RetrievedImpl) then) =
      __$$RetrievedImplCopyWithImpl<$Res>;
  @useResult
...
/// @nodoc
class __$$RetrievedImplCopyWithImpl<$Res>
    extends _$UserProfileStateCopyWithImpl<$Res, _$RetrievedImpl>
    implements _$$RetrievedImplCopyWith<$Res> {
  __$$RetrievedImplCopyWithImpl(
      _$RetrievedImpl _value, $Res Function(_$RetrievedImpl) _then)
      : super(_value, _then);
...
class _$RetrievedImpl implements _Retrieved {
  const _$RetrievedImpl(this.user);
  ...
  @override
  String toString() {
    return 'UserProfileState.retrieved(user: $user)';
  }
  ...
  _$$RetrievedImplCopyWith<_$RetrievedImpl> get copyWith =>
      __$$RetrievedImplCopyWithImpl<_$RetrievedImpl>(this, _$identity);
...
abstract class _Retrieved implements UserProfileState {
  const factory _Retrieved(final UserData user) = _$RetrievedImpl;
