                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            SizedBox(
                              ...
                              child: Align(
                                ...
                                child: Column(
                                  children: [
                                    Text("No favorites added yet, select ‘New Folder’", style: TextStyle(color: AppColors.descText, fontSize: 14.sp)),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          InkWell(
                            onTap: () {
                              Get.to(() => const AllSupportSchemesScreen());
                            },
                            child: Text("See all",
                                style: Theme.of(context)
                                    .textTheme
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                List<FgnSupportSchemeModel> supportSchemes = _supportSchemes;
                                return GestureDetector(
                                  onTap: () => Get.to(() => SupportDetailsScreen(
                                        id: supportSchemes[index].id,
                                        title: supportSchemes[index].title,
                                        body: supportSchemes[index].body,
                                        url: "https://res.cloudinary.com/peterojo/image/upload/v1722668589/Coat_of_arms_of_Nigeria_isabtv.png",
